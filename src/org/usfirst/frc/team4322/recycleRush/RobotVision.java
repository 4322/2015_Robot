...
public class RobotVision {
	...
	// Singleton Instance
	private static RobotVision _instance = null;
	...
	public void initRobotVision()
	{
		...
		{
			RobotLogger.getInstance().writeErrorToFile("initRobotVision()", ex);
		}
 	}
	...
	public void runTeleop()
	{
		...
		if (numParticles > 0)
		{
			...
			if(isTote)
			{
				RobotLogger.getInstance().sendToConsole("TOTE FOUND!"); //currently does not work
			}
